...
class CState_Vehicle_Idle final : public CState
{
public:
	CState_Vehicle_Idle(ComPtr<ID3D11Device> pDevice, ComPtr<ID3D11DeviceContext> pContext);
	virtual ~CState_Vehicle_Idle() = default;
