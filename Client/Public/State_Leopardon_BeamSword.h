...
class CState_Leopardon_BeamSword final : public CState
{
public:
	CState_Leopardon_BeamSword(ComPtr<ID3D11Device> pDevice, ComPtr<ID3D11DeviceContext> pContext);
	virtual ~CState_Leopardon_BeamSword() = default;
