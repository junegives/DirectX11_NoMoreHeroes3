...
class CState_Vehicle_Jump final : public CState
{
public:
	CState_Vehicle_Jump(ComPtr<ID3D11Device> pDevice, ComPtr<ID3D11DeviceContext> pContext);
	virtual ~CState_Vehicle_Jump() = default;
