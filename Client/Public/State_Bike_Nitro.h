...
class CState_Bike_Nitro final : public CState
{
public:
	CState_Bike_Nitro(ComPtr<ID3D11Device> pDevice, ComPtr<ID3D11DeviceContext> pContext);
	virtual ~CState_Bike_Nitro() = default;
