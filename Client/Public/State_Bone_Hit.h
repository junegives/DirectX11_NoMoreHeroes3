...
class CState_Bone_Hit final : public CState
{
public:
	CState_Bone_Hit(ComPtr<ID3D11Device> pDevice, ComPtr<ID3D11DeviceContext> pContext);
	virtual ~CState_Bone_Hit() = default;
