...
class CState_Bike_MiniGame_Avoid final : public CState
{
public:
	CState_Bike_MiniGame_Avoid(ComPtr<ID3D11Device> pDevice, ComPtr<ID3D11DeviceContext> pContext);
	virtual ~CState_Bike_MiniGame_Avoid() = default;
