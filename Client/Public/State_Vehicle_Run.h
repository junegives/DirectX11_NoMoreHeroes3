...
class CState_Vehicle_Run final : public CState
{
public:
	CState_Vehicle_Run(ComPtr<ID3D11Device> pDevice, ComPtr<ID3D11DeviceContext> pContext);
	virtual ~CState_Vehicle_Run() = default;
